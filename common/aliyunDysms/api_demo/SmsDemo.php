...
class SmsDemo
{
     ...
     * @return stdClass
     */
    public static function sendSms($mobile,$address) {
        ...
        $request->setSignName("新罗停车无忧");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_127155723");
    ...
    public static function sendVerifyCode($mobile) {
        ...
        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_126876789");

        // 可选，设置模板参数, 假如模板中存在变量需要替换则为必填项
        $request->setTemplateParam(json_encode(array(  // 短信模板中字段的值
            "code"=>$random,
        ), JSON_UNESCAPED_UNICODE));
        \Yii::$app->cache->set($mobile,$random,120);
