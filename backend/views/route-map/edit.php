...
\backend\assets\RouteMapAsset::register($this);
...
/* 页面基本属性 */
$this->title = '添加地点';
$this->params['title_sub'] = '添加地点';  // 在\yii\base\View中有$params这个可以在视图模板中共享的参数
...
<div class="portlet light bordered">
    ...
    <div class="portlet-body form">
        ...
        <div class="form-group field-route-remark">
            ...
            <div id="r-result" style="width: 100%">位置搜索:<input class="form-control" type="text" id="suggestId" size="20" value="百度" style="width:150px;" /></div>
...
highlight_subnav('route-map/index'); //子导航高亮
});
<?php $this->endBlock() ?>
<!-- 将数据块 注入到视图中的某个位置 -->
